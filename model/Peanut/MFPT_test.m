...
system_type                        = 'Sph_double_well_equal'; 
relearn_option                     = 1;
disp(['Starting ',system_type,' model.'])
addpath_settings;
set_parameter;
disp('Parameter is set') 
diary_fileName                     = [datapath,'diary_FPT.txt'];
...
for k = 1:10
    ...
    if k == 1
        ...
        disp(['The original simulator at cyan state in case 1 has ', num2str(mean(FPT_ori1),'%5.1f'),'+-',num2str(std(FPT_ori1)*1.96/sqrt(N),'%5.1f')])
        disp(['The original simulator at Red state in case 1 has ', num2str(mean(FPT_ori2),'%5.1f'),'+-',num2str(std(FPT_ori2)*1.96/sqrt(N),'%5.1f')])
        disp(['The original simulator at cyan state in case 2 has ', num2str(mean(FPT_ori3),'%5.1f'),'+-',num2str(std(FPT_ori3)*1.96/sqrt(N),'%5.1f')])
        disp(['The original simulator at Red state in case 2 has ', num2str(mean(FPT_ori4),'%5.1f'),'+-',num2str(std(FPT_ori4)*1.96/sqrt(N),'%5.1f')])
        
        disp(['Oblique projection'])
        disp(['The ATLAS simulator at cyan state in case 1 has ', num2str(mean(FPT_sim1),'%5.1f'),'+-',num2str(std(FPT_sim1)*1.96/sqrt(N),'%5.1f')])
        disp(['The ATLAS simulator at Red state in case 1 has ', num2str(mean(FPT_sim2),'%5.1f'),'+-',num2str(std(FPT_sim2)*1.96/sqrt(N),'%5.1f')])
        disp(['The ATLAS simulator at cyan state in case 2 has ', num2str(mean(FPT_sim3),'%5.1f'),'+-',num2str(std(FPT_sim3)*1.96/sqrt(N),'%5.1f')])
        disp(['The ATLAS simulator at Red state in case 2 has ', num2str(mean(FPT_sim4),'%5.1f'),'+-',num2str(std(FPT_sim4)*1.96/sqrt(N),'%5.1f')])
        
        disp(['Orthogonal Projection'])
        disp(['The ATLAS simulator at cyan state in case 1 has ', num2str(mean(FPT_ort1),'%5.1f'),'+-',num2str(std(FPT_ort1)*1.96/sqrt(N),'%5.1f')])
        disp(['The ATLAS simulator at Red state in case 1 has ', num2str(mean(FPT_ort2),'%5.1f'),'+-',num2str(std(FPT_ort2)*1.96/sqrt(N),'%5.1f')])
        disp(['The ATLAS simulator at cyan state in case 2 has ', num2str(mean(FPT_ort3),'%5.1f'),'+-',num2str(std(FPT_ort3)*1.96/sqrt(N),'%5.1f')])
        disp(['The ATLAS simulator at Red state in case 2 has ', num2str(mean(FPT_ort4),'%5.1f'),'+-',num2str(std(FPT_ort4)*1.96/sqrt(N),'%5.1f')])
...
save(Peanut_analysis_fileName,'Mean_FPT','relative_error','t_final')
